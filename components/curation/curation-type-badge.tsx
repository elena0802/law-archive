...
const variantClassName = {
  ...
  compact:
    "border-line bg-paper-muted px-2 py-0.5 text-[0.6875rem] font-medium tracking-[0.08em] text-ink-muted",
} as const;
...
export function CurationTypeBadge({
  ...
  return (
    <span
      className={`text-keep inline-flex w-fit max-w-full shrink-0 rounded-sm border ${variantClassName[variant]} ${className}`}
    >
